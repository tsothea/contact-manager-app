...
const Title = (props) => {
    ...
    return (
        <div className="header-title">
            ...
            <a href="#" onClick={(e) => changeDisplay(e, false)}><span className={"fa fa-th grid " + displayGride}></span></a>
            <a href="#" onClick={(e) => changeDisplay(e, true)}><span className={"fa fa-bars grid " + displayList}></span></a>
            <span className="text-right">
            <span className="fa fa-map-marker icon-map"></span>
            <select className="location-opt" name="location" onChange={(e) => dispatch(filterLocation(e.target.value))}>
